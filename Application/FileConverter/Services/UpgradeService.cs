...
namespace FileConverter.Services
{
    ...
    {
#if DEBUG
        private const string BaseURI = "https://raw.githubusercontent.com/IVENWG/FileConverter/integration/";
#else
        private const string BaseURI = "https://raw.githubusercontent.com/IVENWG/FileConverter/master/";
#endif
        ...
        private async Task DownloadInstaller()
        {
            ...
            {
                Debug.LogError("Failed to download the new LessMB Converter upgrade. You should try again or download it manually.");
