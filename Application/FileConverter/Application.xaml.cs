...
namespace FileConverter
{
    ...
    public partial class Application : System.Windows.Application
    {
        ...
        {
#if BUILD32
            Diagnostics.Debug.Log("LessMB Converter v" + ApplicationVersion.ToString() + " (32 bits)");
#else
            Diagnostics.Debug.Log("LessMB Converter v" + ApplicationVersion.ToString() + " (64 bits)");
#endif
        ...
        private void RunConversions(List<string> filePaths, string conversionPresetName)
        {
            ...
            {
                Debug.LogError(errorCode: 0x04, "Can't load LessMB Converter settings. The application will now shutdown, if you want to fix the problem yourself please edit or delete the file: C:\\Users\\UserName\\AppData\\Local\\FileConverter\\Settings.user.xml.");
                Application.AskForShutdown();
                return;
            }
