...
namespace FileConverter
{
    ...
    public static class Helpers
    {
        ...
        public static bool RegisterShellExtension(string shellExtensionPath)
        {
            ...
            {
                Diagnostics.Debug.LogError("LessMB Converter needs administrator privileges to register the shell extension.");
                return false;
            }
        ...
        public static bool UnregisterExtension(string shellExtensionPath)
        {
            if (!Application.IsInAdmininstratorPrivileges)
            {
                Diagnostics.Debug.LogError("LessMB Converter needs administrator privileges to unregister the shell extension.");
                return false;
            }
